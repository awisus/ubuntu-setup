...
gsettings set org.gnome.shell favorite-apps "['org.gnome.Nautilus.desktop', 'org.gnome.Terminal.desktop', 'firefox.desktop', 'thunderbird.desktop', 'signal-desktop.desktop', 'steam.desktop', 'intellij-idea_intellij-idea.desktop', 'com.blackmagicdesign.resolve.desktop', 'com.obsproject.Studio.desktop']"
